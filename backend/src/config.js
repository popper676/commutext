...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '2a60ffc451480da623ae4980708f1cd9',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'commutext <app@flatlogic.app>',
  ...
  project_uuid: 'a2c06b91-f887-402e-af90-323bad640d69',
  flHost:
...
config.pexelsQuery = 'calm communication metaphor';
config.host =
