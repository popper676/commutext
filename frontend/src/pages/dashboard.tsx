...
const Dashboard = () => {
  ...
  const [texts, setTexts] = React.useState('Loading...');
  const [translations, setTranslations] = React.useState('Loading...');
  ...
  async function loadData() {
    const entities = ['users', 'texts', 'translations', 'roles', 'permissions'];
    const fns = [setUsers, setTexts, setTranslations, setRoles, setPermissions];
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_TEXTS') && (
            <Link href={'/texts/texts-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiText || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_TRANSLATIONS') && (
