...
const ListTexts = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_TEXTS');
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>CreatedOn</p>
                    <p className={'line-clamp-2'}>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/texts/texts-edit/?id=${item.id}`}
                  pathView={`/texts/texts-view/?id=${item.id}`}
