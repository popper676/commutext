...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/texts/textsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTextsCols';
...
const TableSampleTexts = ({
  ...
  const {
    ...
    notify: textsNotify,
    refetch,
  } = useAppSelector((state) => state.texts);
  ...
  useEffect(() => {
    if (textsNotify.showNotification) {
      notify(textsNotify.typeNotification, textsNotify.textNotification);
    }
  }, [textsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/texts/texts-view/?id=${id}`);
  };
...
export default TableSampleTexts;
